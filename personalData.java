...
public class personalData {
	...
	public personalData(String name, int age, int h) {
		super();
		this.name = name;
		this.age = age;
		this.h = h;
	...
	void checkWt() {
		int wt = getWeight();
		if(wt >= 35 && wt <= 70) {
			System.out.println(wt +  "kg: 'Healthy Weight'! Congratulations you are within the defined range of weight.");
		} else {
			System.out.println(wt +  "kg: 'Overweight'! Your weight is above the standard weight. It denotes that you are at risk of several diseases and have to adopt remedial measures for weight loss");
		}
	}
